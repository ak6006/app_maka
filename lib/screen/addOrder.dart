...
class _AddOrderScreenState extends State<AddOrderScreen> {
  ...
  //   return null;
  // }
  slid_table(BuildContext context) {
              ...
              Expanded(
                child: Container(
                  child: RefreshIndicator(
                    ...
                    child: snapshotdata.data.status == Status.COMPLETED
                        ? ListView(
                                  ...
                                  Container(
                                    ...
                                    child: new FlatButton(
                                      onPressed: () async {
                                        ...
                                        var result1 = await Connectivity()
                                            .checkConnectivity();
                                        if (result1 ==
  ...
  Future<String> vaildurl(String path) async {
    ...
    return Container(
      ...
      child: CarouselSlider(
        options: CarouselOptions(
          height: 500.0,
          autoPlay: false, // widget.autoplay,
          aspectRatio: 16 / 9,
        ...
        items: productItems.map((i) {
          ...
          return FutureBuilder(
            future: vaildurl(
                'http://teamiegypt-001-site1.atempurl.com/imgs/product_${i.id}.png'),
            initialData: Uri.parse('assets/images/Loading.jpg').path,
            //  "http://teamiegypt-001-site1.atempurl.com/imgs/product_1.png",
              ...
              return Container(
                ...
                child: RightImageProductImageWidget(
                  ...
                  product: new Product(
                    ...
                    //'http://teamiegypt-001-site1.atempurl.com/imgs/product_${i.id}.png', //'assets/images/${i.id}.png',
                    name: i.name,
