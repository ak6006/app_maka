...
//       body: Stack(children: [
//         Hero(
//           tag: 'الجائزة مقدمة من مكة هاي فيد', //champion.name.toUpperCase(),
//           child: ShaderMask(
//               shaderCallback: (rect) {
...
//                                           children: [
//                                             Image.asset(
//                                                 "assets/images/${champion.role.toString().split(".")[1].toLowerCase()}.png",
//                                                 width: 40,
//                                                 height: 40),
//                                             SizedBox(
//                                               height: 20,
...
class _DetailViewState extends State<DetailView> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(children: [
        Hero(
          tag: '222الجائزة مقدمة من مكة هاي فيد', //champion.name.toUpperCase(),
          child: ShaderMask(
            shaderCallback: (rect) {
              return LinearGradient(
                begin: Alignment.topCenter,
                                      ...
                                      Column(
                                          ...
                                          children: [
                                            ...
                                            Text('الجائزة', //"ROLE",
                                                style: textTheme.headline3),
                                            Text(
                                                'عند شراء اكثر من ${int.parse(champion.count) * 100} شيكارة',
                                                // champion.role
                                                //     .toString()
                                                //     .split(".")[1],
                                                style: textTheme.headline3
