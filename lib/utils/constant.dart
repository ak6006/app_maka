...
Future inislizedata(DropDownList data) async {
  ...
  numbers.add(NumbersDigits(name: "واحد", digit: "1"));
  numbers.add(NumbersDigits(name: "اثنين", digit: "2"));
  numbers.add(NumbersDigits(name: "ثلاثه", digit: "3"));
  numbers.add(NumbersDigits(name: "اربعه", digit: "4"));
  numbers.add(NumbersDigits(name: "خمسه", digit: "5"));
  numbers.add(NumbersDigits(name: "سته", digit: "6"));
  numbers.add(NumbersDigits(name: "سبعه", digit: "7"));
  numbers.add(NumbersDigits(name: "ثمانيه", digit: "8"));
  numbers.add(NumbersDigits(name: "تسعه", digit: "9"));
  numbers.add(NumbersDigits(name: "عشره", digit: "10"));
        ...
        imageHero: Hero(
          ...
          child: ClipRRect(
            ...
            child: CachedNetworkImage(
              ...
              imageUrl:
                  'http://teamiegypt-001-site1.atempurl.com/imgs/gift_${h.giftid}.jpg',
